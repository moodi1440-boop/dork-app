...
**الحالة: ✅ مرحلة 1 مكتملة ومرفوعة على `main`** — صالون "الوادي" جاهز الآن لتفعيل الجلسة الحقيقية عند أول دخول قادم. **التالي:** التحقق من `auth_uid` بعد أول دخول، ثم المرحلة 2 (سياسات RLS الفعلية على DORK-TEST).
