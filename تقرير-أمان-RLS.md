...
**⏳ ملاحظة متبقية غير عاجلة:** الرسائل تصل حالياً لمجلد Spam بجيميل (متوقع، لأن `onboarding@resend.dev` نطاق تجريبي مشترك غير موثّق باسمنا). الحل الحقيقي: توثيق نطاق بريد خاص (SPF/DKIM/DMARC) عند Resend — يحتاج وصول DNS، مؤجَّل لجلسة لاحقة.
