    ...
    <div className="min-h-screen bg-navy flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-black gold-text tracking-widest">DAWRAK</h1>
        ...
        <p className="text-center text-gray-600 text-xs mt-6">DAWRAK Salon Booking — Admin Panel</p>
      </div>
    </div>
  );
}
