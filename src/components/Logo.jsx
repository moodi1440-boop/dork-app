...
function DorkLogoSvg({size=40}){
  return(
    <svg width={size} height={size} viewBox="0 0 100 110" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="5" y="4" width="90" height="102" rx="22" ry="22" stroke="url(#dlg)" strokeWidth="4" fill="none"/>
      <path d="M 22 46 A 28 28 0 0 1 78 46" stroke="url(#dlg)" strokeWidth="3.8" fill="none" strokeLinecap="round"/>
      ...
      <line x1="22" y1="94" x2="79" y2="22" stroke="url(#dlg)" strokeWidth="5.5" strokeLinecap="round"/>
      <line x1="78" y1="94" x2="21" y2="22" stroke="url(#dlg)" strokeWidth="5.5" strokeLinecap="round"/>
      ...
      <path d="M 50 89 C 47 86 44 83 44 80.5 A 6 6 0 0 1 56 80.5 C 56 83 53 86 50 89 Z" fill="url(#dlg)"/>
