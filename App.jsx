...
const APP_VERSION = "2026.05.31-M";
    ...
    return(
      <div style={G.topBar}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:6,cursor:"pointer",lineHeight:1}} onClick={()=>resetHome&&resetHome()}>
          ...
          <span style={{fontSize:30,fontWeight:700,fontFamily:"'Cinzel',serif",background:"linear-gradient(180deg,#f7e7b7,#e6c980,#d4b15f,#f1d99c,#c9a24a)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",backgroundClip:"text",letterSpacing:3}}>DORK</span>
        </div>
      </div>
    );
  }
