...
const APP_VERSION = "2026.05.31-T";
  ...
  if(customerSession&&!ownerSession){
    return(
      <div style={G.topBar}>
        ...
        {/* RIGHT: شعار */}
        <div style={{display:"flex",alignItems:"center",gap:6,cursor:"pointer",lineHeight:1,marginLeft:10}} onClick={()=>resetHome&&resetHome()}>
          <span style={{fontSize:17,fontWeight:700,color:"#e6c980",letterSpacing:0.5,lineHeight:1}}>احجز</span>
          <span style={{fontSize:40,fontWeight:900,fontFamily:"'Cormorant SC',serif",background:"linear-gradient(180deg,#fff8e1 0%,#f7e7b7 15%,#e6c670 40%,#d4a827 65%,#c9a24a 85%,#8b6200 100%)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",backgroundClip:"text",WebkitTextStroke:"0.5px #d4a827",letterSpacing:1,lineHeight:1}}>DORK</span>
        </div>
      </div>
    );
  }
