  ...
  const inner=(
    <>
      ...
      {step===1&&<div style={G.fc}>
        ...
        <F label="رقم الجوال" error={errors.phone}><input style={fi(errors.phone)} inputMode="numeric" type="tel" lang="en" placeholder="05XXXXXXXX" value={form.phone} onChange={e=>setForm(p=>({...p,phone:e.target.value}))}/></F>
  ...
  return(
    <div style={G.page}><div style={G.fp}>
      ...
      <div style={G.fc}>
        ...
        <F label="جوال المالك (للدخول لاحقاً)" error={errors.ownerPhone}><input style={fi(errors.ownerPhone)} inputMode="numeric" type="tel" lang="en" placeholder="05XXXXXXXX" value={form.ownerPhone} onChange={e=>setForm(p=>({...p,ownerPhone:e.target.value}))}/></F>
        <F label="جوال الصالون" error={errors.phone}><input style={fi(errors.phone)} inputMode="numeric" type="tel" lang="en" placeholder="05XXXXXXXX" value={form.phone} onChange={e=>setForm(p=>({...p,phone:e.target.value}))}/></F>
    ...
    <div style={G.page}><div style={G.fp}>
      ...
      <div style={G.fc}>
        {tab==="phone"?<>
          ...
          <F label="رقم الجوال" error={err}><input style={fi(err)} inputMode="numeric" type="tel" lang="en" placeholder="05XXXXXXXX" value={phone} onChange={e=>{setPhone(e.target.value);setErr("");}}/></F>
    ...
    <div style={G.page}><div style={G.fp}>
      ...
      <div style={G.fc}>
        {tab==="login"?<>
          ...
          <F label="رقم الجوال"><input style={fi()} inputMode="numeric" type="tel" lang="en" placeholder="05XXXXXXXX" value={phone} onChange={e=>{setPhone(e.target.value);setErr("");}}/></F>
