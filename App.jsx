...
const APP_VERSION = "2026.05.31-P";
    ...
    return(
      <div style={G.topBar}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:6,cursor:"pointer",lineHeight:1}} onClick={()=>resetHome&&resetHome()}>
          ...
          <span style={{fontSize:38,fontWeight:900,fontFamily:"'Cinzel',serif",background:"linear-gradient(180deg,#fff8e1 0%,#f7e7b7 12%,#e6c670 28%,#8b6200 50%,#d4a827 65%,#f1d99c 80%,#c9a24a 100%)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",backgroundClip:"text",letterSpacing:1,lineHeight:1}}>DORK</span>
        </div>
      </div>
    );
  }
